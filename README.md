...
- **Vérifications anti-robot (Cloudflare, DataDome…) :** Glaneur ne les contourne pas. Il les reconnaît et le dit, plutôt que de lire la page de vérification. Avec le rendu JavaScript, il laisse quelques secondes aux vérifications automatiques, comme n’importe quel navigateur. Pour ces sites, cherchez un flux officiel (souvent épargné par la vérification) ou une route RSSHub.
